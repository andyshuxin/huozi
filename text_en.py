...
txt = {
       ...
       'OpenIssueT':    "Open issue",
       'ConfirmNewT':   "Confirm Creating New Issue",
       'ConfirmNewQ':   "All unsaved progress would be lost. Confirm?",
       'ConfirmOpenT':  "Confirm Opening",
       'ConfirmOpenQ':  "All unsaved progress would be lost. Confirm?",
       'ConfirmQuitT':  "Confirm Leaving",
       'ConfirmQuitQ':  "All unsaved progress would be lost. Confirm?",
       'DelArticle':    "Delete ",
       ...
       'MainTextH':     "Main text (please don't edit subtitles here):",
       'TeaserTextH':   "Digest of the article:",

       # AddMultipleArticleFrame
       ...
       # ConfigIssueFrame
       'ConfigIssueT':     "Configure Issue",
       'hintGrandTitle':   "General Title of the Issue:",
       'hintYear':         "Year",
       'hintMonth':        "Month",
       'hintDay':          "Day",
